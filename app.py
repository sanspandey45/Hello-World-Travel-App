...
if st.session_state.page == "itinerary":
    ...
    def handle_chat_input():
        ...
        if user_message:
            ...
            if "show itinerary" in message_lower or "view itinerary" in message_lower or "my itinerary" in message_lower or "view" in message_lower or "show" in message_lower:
